# Run Selenium Tests with Ruby on HyperExecute by TestMu AI (Formerly LambdaTest)
...
- Ruby (latest stable) and Bundler. Download the HyperExecute CLI for your OS from https://downloads.lambdatest.com/hyperexecute/
...
```bash
git clone https://github.com/LambdaTest/Ruby-HyperExecute-Sample && cd Ruby-HyperExecute-Sample
